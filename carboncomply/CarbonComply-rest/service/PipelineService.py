...
class PipelineService(metaclass=Singleton):
    ...
    def _define_prefixes(self, graph: Graph):
        ...
        ontology_se_cbam = rdflib.Namespace('https://purl.org/cbam/')
        ontology_se_cbam_emissionsqualifyingparameters = rdflib.Namespace('https://purl.org/cbam/emissionsqualifyingparameters/')
        ontology_se_cbam_cn = rdflib.Namespace('https://purl.org/cbam/CN/')
        ontology_se_cbam_cbamreport = rdflib.Namespace('https://purl.org/cbam/cbamreport/')
        ontology_se_cbam_electricity_determination = rdflib.Namespace('https://purl.org/cbam/Electricity_Determination/')
        ontology_se_cbam_instrument = rdflib.Namespace('https://purl.org/cbam/Instrument/')
        ontology_se_cbam_country = rdflib.Namespace('https://purl.org/cbam/CountryPlus/')
        ontology_se_cbam_currency = rdflib.Namespace('https://purl.org/cbam/currency/')
        ontology_se_cbam_production_method = rdflib.Namespace('https://purl.org/cbam/Production_Method/')
        ontology_se_cbam_cbam_goods = rdflib.Namespace('https://purl.org/cbam/cbam_goods/')
        se_cbam = rdflib.Namespace('https://data.siemens-energy.com/cbam#')
        se_cbam_emissionsqualifyingparameters = rdflib.Namespace('https://data.com/cbam/emissionsqualifyingparameters#')
        se_cbam_cn = rdflib.Namespace('https://data.com/cbam/CN#')
        se_cbam_cbamreport = rdflib.Namespace('https://data.com/cbam/cbamreport#')
        se_cbam_electricity_determination = rdflib.Namespace('https://data.com/cbam/Electricity_Determination#')
        se_cbam_instrument = rdflib.Namespace('https://data.com/cbam/Instrument#')
        se_cbam_country = rdflib.Namespace('https://data.com/cbam/CountryPlus#')
        se_cbam_currency = rdflib.Namespace('https://data.com/cbam/currency#')
        se_cbam_production_method = rdflib.Namespace('https://data.com/cbam/Production_Method#')
        se_cbam_cbam_goods = rdflib.Namespace('https://data.com/cbam/cbam_goods#')
